...
---
<figure> <picture> <source class="responsive-img-srcset" srcset="/assets/img/turret.jpg" sizes="(min-width: 930px) 270.0px, (min-width: 576px) 30vw, 95vw"> <img src="/assets/img/turret.jpg" class="img-fluid z-depth-1 rounded" width="100%" height="auto" alt="turret.jpg" loading="eager" onerror="this.onerror=null; $('.responsive-img-srcset').remove();"> </picture> </figure>
